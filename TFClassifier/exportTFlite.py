...
def tflitequanexport(saved_model_dir):
    ...
    train_ds, val_ds, class_names, imageshape = loadTFdataset('flower', 'customtfrecordfile', '/Users/daijunq/Desktop/dee/github/MultiModalClassifier/outputs/TFrecord', 180, 180, 32)
